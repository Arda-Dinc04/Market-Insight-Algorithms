...
def generate_large_ticker_list():
    exchanges = ['AAPL', 'MSFT', 'GOOGL', 'AMZN', 'FB', 'TSLA', 'BRK-A', 'JNJ', 'V', 'WMT', 'JPM', 'PG', 'UNH', 'DIS', 'NVDA', 'HD', 'MA', 'VZ', 'PYPL', 'ADBE', 'NFLX', 'KO', 'PEP', 'PFE', 'INTC', 'CSCO', 'MRK', 'CMCSA', 'NKE', 'T', 'XOM', 'MCD', 'HON', 'IBM', 'BA', 'GE', 'SBUX', 'MMM', 'GS', 'CAT', 'AXP', 'CVX', 'ORCL', 'AMGN', 'QCOM', 'TXN', 'COST', 'WFC', 'MDT', 'BMY']
